...
class QRimage {
	...
	private static function image($frame, $pixelPerPoint = 4, $outerFrame = 4) {
        ...
        if(file_exists(dirname(__FILE__)."/mark.png")){
            $mark_image = @imagecreatefrompng(dirname(__FILE__)."/mark.png");
            imageAlphaBlending($mark_image, true);
            imageSaveAlpha($mark_image, true);
            @imagecopy($target_image, $mark_image, ($imgW * $pixelPerPoint/2)-(74/2), ($imgH * $pixelPerPoint/2)-(74/2), 0,0, 74, 74);
        }
